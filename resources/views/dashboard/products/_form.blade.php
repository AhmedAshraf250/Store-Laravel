<div class="form-group">
    <x-form.input label="Product Name" class="form-control form-control-lg" role="input" name="name"
        :value="$product->name" />
</div>
...
<div class="form-group">
    ...
    <x-form.input type="file" name="image" accept="image/*" class="form-control-file" />
    @if ($product->image)
